...
const PianoScreen = () => {
  ...
  const challengeId = 'piano'; // ピアノのチャレンジID
  const challengeName = 'ピアノ練習';
  ...
  const [currentPiece, setCurrentPiece] = useState('ショパン - ノクターン Op.9 No.2');
  const [practiceTechniques, setPracticeTechniques] = useState(['スケール練習', '両手の独立', 'リズム練習']);
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>ピアノ練習</Text>
        ...
        <View style={styles.pieceContainer}>
          <Text style={styles.sectionTitle}>現在の練習曲</Text>
          <View style={styles.currentPieceCard}>
            <Text style={styles.pieceTitle}>{currentPiece}</Text>
            <View style={styles.progressBar}>
              <View style={[styles.progressFill, { width: '45%' }]} />
            </View>
            <Text style={styles.progressText}>習得度: 45%</Text>
          </View>
        </View>

        {/* 練習テクニック */}
        <View style={styles.techniquesContainer}>
          <Text style={styles.sectionTitle}>練習テクニック</Text>
          {practiceTechniques.map((technique, index) => (
        ...
        <View style={styles.actionContainer}>
          ...
          >
            <Text style={styles.startButtonText}>練習開始</Text>
          </TouchableOpacity>
